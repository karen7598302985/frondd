...
router.get('/crearcita3.png', (req, res) => {
  res.sendFile(path.join(__dirname, '../complementos', 'img', 'crearcita3.png'));
});


router.get('/img.jpg', (req, res) => {
  res.sendFile(path.join(__dirname, '../complementos', 'img', 'img.jpg'));
});
router.get('/crearcita2.png', (req, res) => {
  res.sendFile(path.join(__dirname, '../complementos', 'img', 'crearcita2.png'));
});
/////////// reviews /////////
//uris de de reviews
